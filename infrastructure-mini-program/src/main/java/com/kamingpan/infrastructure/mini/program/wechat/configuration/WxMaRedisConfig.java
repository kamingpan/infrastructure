...
public class WxMaRedisConfig implements WxMaConfig {
    ...
    public String getRedisKey(String key) {
        StringBuilder redisKey = new StringBuilder("MINI_PROGRAM:");
        if (maId == null) {
    ...
    public Lock getAccessTokenLock() {
        if (accessTokenLock == null) {
            synchronized (this) {
                if (accessTokenLock == null) {
                    accessTokenLock = new WxMaRedisConfig.DistributedLock(getRedisKey("accessTokenLock"));
                }
            }
        }
    ...
    public Lock getJsapiTicketLock() {
        if (jsapiTicketLock == null) {
            synchronized (this) {
                if (jsapiTicketLock == null) {
                    jsapiTicketLock = new WxMaRedisConfig.DistributedLock(getRedisKey("jsapiTicketLock"));
                }
            }
        }
    ...
    public Lock getCardApiTicketLock() {
        if (cardApiTicketLock == null) {
            synchronized (this) {
                if (cardApiTicketLock == null) {
                    cardApiTicketLock = new WxMaRedisConfig.DistributedLock(getRedisKey("cardApiTicketLock"));
                }
            }
        }
